...
Fitted subway exposure
  & $-$0.0709$^{*}$ & $-$0.0760       & 0.0103         & $-$0.0024 \\
  & (0.0403)        & (0.0448)        & (0.0201)       & (0.0095) \\[4pt]
Lagged dependent variable
  & $-$0.3613$^{***}$ & $-$0.3724$^{***}$ & $-$0.1501$^{**}$ & $-$0.2579$^{***}$ \\
  & (0.0865)        & (0.0943)        & (0.0620)       & (0.0430) \\[4pt]
\midrule
...
RMSE                       & 0.352 & 0.373 & 0.090 & 0.053 \\
Adjusted $R^2$             & 0.509 & 0.464 & 0.223 & 0.430 \\
First-stage $F$-statistic  & 842.7 & 844.0 & 780.1 & 891.8 \\
Wu--Hausman $p$-value      & 0.504 & 0.264 & 0.910 & 0.919 \\
\midrule
...
\midrule
Fitted subway exposure
  & $-$0.0020         & $-$0.0011         & 0.0005            & 0.0084$^{**}$     & $-$0.0041 \\
  & (0.0042)          & (0.0026)          & (0.0055)          & (0.0040)          & (0.0110) \\[4pt]
Lagged dependent variable
  & $-$0.6050$^{***}$ & $-$0.7146$^{***}$ & $-$0.3678$^{***}$ & $-$0.0877         & $-$0.7166$^{***}$ \\
  & (0.0549)          & (0.0395)          & (0.1174)          & (0.0676)          & (0.0766) \\[4pt]
\midrule
...
RMSE                       & 0.041  & 0.019  & 0.064  & 0.019  & 0.034 \\
Adjusted $R^2$             & 0.527  & 0.728  & 0.717  & 0.333  & 0.554 \\
First-stage $F$-statistic  & 853.3  & 847.5  & 840.0  & 847.9  & 835.1 \\
Wu--Hausman $p$-value      & 0.036  & 0.118  & 0.554  & 0.012  & 0.256 \\
\midrule
...
\midrule
Fitted subway exposure
  & 0.0158$^{**}$     & 0.0810$^{**}$     & 0.1012$^{**}$ \\
  & (0.0070)          & (0.0308)          & (0.0379) \\[4pt]
Lagged dependent variable
  & $-$0.9054$^{***}$ & $-$0.2385$^{***}$ & $-$0.2110$^{**}$ \\
  & (0.0422)          & (0.0735)          & (0.0756) \\[4pt]
\midrule
...
Adjusted $R^2$            & 0.293  & 0.364  & 0.331 \\
First-stage $F$-statistic & 845.4  & 855.3  & 860.0 \\
Wu--Hausman $p$-value     & 0.027  & $<0.001$ & $<0.001$ \\
\midrule
