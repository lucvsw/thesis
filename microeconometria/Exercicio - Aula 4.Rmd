...
```{r, include=FALSE}
# Pacotes necessários
pacotes <- c("dplyr", "haven", "tinytex", "ggplot2", "fixest")
...
dados <- read_dta("/Users/lucas/Desktop/Lucas/Doutorado/2º Semestre/Microeconometria/Aulas/Aula 4 - Replication 1/data/final_HS_data.dta")
